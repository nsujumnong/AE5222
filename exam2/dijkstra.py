...
class dijkstra:
    ...
    def __init__(self, start, end, grid):
        ...
        #print len(path)
        print "cost = ", last._cost
        print "count =", self._count
        print "path = ", self.makePath(path)
        print "length = ", len(self.makePath(path))
    ...
    def dijkstra(self  ):
        ...
        #print current
        # keep going until it reactrhs the self._end
